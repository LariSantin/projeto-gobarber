...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  constructor(appointmentRepository, notificationsRepository, cacheProvider) {
  ...
  async execute({
    ...
    const findAppointmentInSameDate = await this.appointmentRepository.findByDate(appointmentDate, provider_id);
