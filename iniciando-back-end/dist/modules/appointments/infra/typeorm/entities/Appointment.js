...
var _Users = _interopRequireDefault(require("../../../../users/infra/typeorm/entities/Users"));
...
let Appointment = (_dec = (0, _typeorm.Entity)('appointments'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('uuid'), _dec3 = Reflect.metadata("design:type", String), _dec4 = (0, _typeorm.Column)(), _dec5 = Reflect.metadata("design:type", String), _dec6 = (0, _typeorm.ManyToOne)(() => _Users.default), _dec7 = (0, _typeorm.JoinColumn)({
  name: 'provider_id'
